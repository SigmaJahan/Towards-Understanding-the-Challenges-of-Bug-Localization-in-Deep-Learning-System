...
def extract_features():
    ...
    git_clone(
        ...
        clone_folder="D:/Bug-Localization-using-DNN-rVSM-for-deep-learning-bugs/data/"
    )

    print ("Repo cloned, now extracting features.")
    ...
    java_src_dict = get_all_source_code('D:\\Bug-Localization-using-DNN-rVSM-for-deep-learning-bugs\\data\\tensorflow')

    #print number of java files
    print("Number of java files: {}".format(len(java_src_dict)))

        # Use all CPUs except one to speed up extraction and avoid computer lagging
    batches = ((extract)(i, br, bug_reports, java_src_dict)
    ...
    features_path = os.path.normpath("D:\\Bug-Localization-using-DNN-rVSM-for-deep-learning-bugs\\data\\features.csv")
